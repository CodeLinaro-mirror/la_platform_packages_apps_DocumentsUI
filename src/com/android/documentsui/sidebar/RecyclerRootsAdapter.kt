...
class RecyclerRootsAdapter(
    ...
    fun onKey(keyCode: Int, event: KeyEvent): Boolean {
        ...
        return when (keyCode) {
             ...
             * they are appropriately handled. See
             * [com.android.documentsui.files.FilesActivity.onKeyDown] and
             * [com.android.documentsui.picker.PickActivity.onKeyDown].
             *
             * The tab press will be bubbled up only when the keyboard navigation feature is
             * enabled, otherwise the event will be swallowed here.
             */
            KeyEvent.KEYCODE_TAB ->
                !mActivity.getInjector().features.isSystemKeyboardNavigationEnabled()
